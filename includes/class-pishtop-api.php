...
class API {
	...
	public static function rerank_candidates( array $current_post_data, array $candidates_data, string $model, int $max_recommendations, int $post_id = 0 ) {
		...
		if ( empty( $custom_prompt ) ) {
			$system_prompt = "You are a content recommendation assistant. Your task is to select the top most relevant and semantically related items for the current post.
Rules:
